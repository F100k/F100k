...
*   **High Performance Computing (HPC) AI Specialist Intern** @ **NSTDA [ThaiSC]** (Jul 2025 - Sep 2025)
    ...
    *   Performed NCCL tuning and benchmarking to improve distributed training performance.
*   **Business Automation Developer (Part-Time)** @ **SCB Techhub** (Dec 2024 - Mar 2025)
    *   Designed and developed business automation solutions using Microsoft Power Apps and Power Automate.
    *   Built low-code applications to streamline internal workflows and reduce manual processes.
